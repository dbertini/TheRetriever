...
public enum ApplicationContext {
	...
	/**
	 * Metodo per controllare se un DataSource � gi� presente
	...
	/**
	 * Metodo per controllare se un {@link Report} � gi� presente nella lista
	...
	/**
	 * Metodo per controllare se un {@link Template} � gi� presente
